              ...
              <div className="card p-0 Test_border-primary rounded-0 Test_hover-shadow">
                ...
                <div className="card-body">
                  ...
                  <p className="card-text mb-4">
                    {" "}
                    تست شخصیت شناسی MBTI با ارزیابی چهار مشخصه رفتاری ، افراد را
                    به شانزده تیپ شخصیتی تقسیم میکند.
                  </p>
                  <a
              ...
              >
                  ...
                  {isExpandedone && (
                    <div className="panel-collapse">
                      <p className="faq-answer">
                        استفاده از انواع تست های خودشناسی و تست شخصیت به مدیران
                        استخدام برای شناسایی متناسب‌ترین افراد برای سازمانشان
                        کمک می‌کند. این کار باعث می‌شود تا هنگام استخدام افراد
                        کلیدی، افراد مناسب بدون هیچ غافلگیری انتخاب شوند.
                      </p>
                    </div>
                  )}
                </li>
                ...
                <li className="question-item">
                  ...
                  >
                    <h3 className="question-title">
                      ...
                      <span className="written_question">
                        چطور تست‌های اینیاک به خودشناسی در روانشناسی کمک می‌کند؟
                      </span>
                    </h3>
                  </div>
                  {isExpandedtwo && (
                    <div className="panel-collapse">
                      <p className="faq-answer">
                        ...
                        بُعد روانشناسی تهیه شده است تا صفات، ویژگی‌ها و ساختاری
                        شخصیتی را بااستفاده از یک سری الگوها، مورد سنجش قرار
                        دهند و به افراد برای کسب شناخت بهتر از خود کمک کند.
                      </p>
                    </div>
                  )}
                </li>
                <li className="question-item">
                  ...
                  {isExpandedthree && (
                    <div className="panel-collapse">
                      <p className="faq-answer">
                        کاربوم با ارائه شناخته‌شده‌ترین و معتبرترین تست‌های دنیا
                        در تلاش است تا به شما برای شناخت بهتر خودتان کمک کند. از
                        جمله این تست‌ها می‌توان از تست MBTI، تست شخصیت شناسی ۵
                        عاملی نئو و تست شخصیت شناسی هارتمن یاد کرد.
                      </p>
                    </div>
                  )}
                </li>
                <li className="question-item">
                  ...
                  {isExpandedfour && (
                    <div className="panel-collapse">
                      <p className="faq-answer">
                        سه تست شخصیت شناسی MBTI، تست هوش ریون و تست شخصیت شناسی
                        هارتمن از تست‌های رایگان شخصیت شناسی به حساب می‌آیند.
                        البته به سایر تست‌های شخصیت شناسی آنلاین را نیز با
                        پرداخت یک مبلغی جزئی می‌توان دسترسی پیدا کرد.
                      </p>
                    </div>
                  )}
                </li>
